...
favoriteBand("Guns n Roses", number: 1)
 ...
 */
func madLibs(characterName: String, noun: String, preposition: String) {
    print("To \(noun) and \(preposition), \(characterName)!")
}
madLibs("Snow White", noun: "rock", preposition: "with")
